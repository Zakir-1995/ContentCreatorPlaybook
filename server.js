...
app.get('/download', async (req, res) => {
  try {
    ...
    /*
     * PDF was uploaded as an IMAGE asset.
     *
     * Cloudinary requires .pdf when delivering the original
     * PDF through the image delivery URL.
     */
    ...
    // ---------------------------------------------------------
    // Redirect customer directly to Cloudinary
    // ---------------------------------------------------------
    //
    // Stripe payment has already been verified above.
    // Cloudinary then serves the PDF directly.
    //
